            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form id="frm_about" method="post" action="{{ route('update.multi.image')}}" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <input name="multi_image" id="multi_image"  class="form-control" type="file">
                                    <div class="rounded avatar-xl mt-4 overflow-hidden" style="width:12rem;height:12rem">
                                        <img id="showImage" class="h-100 w-auto justify-content-center" src="{{asset($multiImage->multi_image) }}" alt="multi_image">                                   
                                    </div>
                                </div>
                            </div>
                            ...
                            <a href="/all/multi/image"  class="btn btn-primary waves-effect waves-light">            
